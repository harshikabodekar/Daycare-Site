      ...
      <div className="bg-gray-50 px-6 py-12 flex flex-col items-center gap-6">
        <div className="grid md:grid-cols-2 gap-6 w-full max-w-5xl">
          ...
          <div className="bg-white p-6 shadow-md rounded-lg">
            <h3 className="text-2xl text-font-semibold mb-2">Mission</h3>
            <p className="text-gray-700">
              Our mission is to deliver high-quality education to children, encourage development of positive habits and skills
              that empower them to achieve lifelong success.
            </p>
          </div>
        ...
        <div className="bg-white p-6 shadow-md rounded-lg w-full max-w-5xl">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <li>Whole-child development: Encouraging emotional, physical, and cognitive growth.</li>
            <li>Fostering independence and confidence in young learners.</li>
          </ul>
        </div>
      </div>
