...
import { FaFacebookF, FaXTwitter, FaLinkedinIn, FaEnvelope, FaPhoneAlt } from "react-icons/fa6";
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          <div className="flex items-center space-x-3 mb-4">
            ...
            />
            <div>
              <h1 className="text-xl font-bold text-purple-800">Clearwater</h1>
              <p className="text-sm text-green-600 -mt-1">Early Learning</p>
            </div>
          </div>
