    ...
    <>
        ...
        <div className="bg-white px-6 py-12 flex flex-col items-center gap-6">
            ...
            <div className="bg-white p-6 rounded-lg border-2">
                ...
                <ul className="text-black">
                 <li> <strong className="text-green-800">Focus Areas:</strong>  Guide students’self-discovery during this sensitive stage of development.</li>
<li> <strong className="text-green-800">Child-teacher ratio:</strong> 6:1 student-to-teacher ratio; well-trained & experienced Early Childhood Educators.</li> </ul>
                </div>
                <div className="bg-white p-6 rounded-lg border-2">
            <h3 className="text-2xl text-black font-semibold mb-2">Vision</h3>
            <p className="text-">
              <ul> </ul>Focus Areas: The Preschool program at Clearwater Early Learning Centre will revolve around building and strengthening the foundations learned by the students in the Toddler program.
Child-teacher ratio:  8:1 student-to-teacher ratio; well-trained & experienced Early Childhood Educators.
            </p>
          </div>
