    ...
    <>
        ...
        <div className="bg-white px-6 py-12 flex flex-col items-center gap-6">
            ...
            <div className="bg-white p-6 rounded-lg border-2">
                ...
                <ul className="text-black">
                 Focus Areas: Guide students’ self-discovery during this sensitive stage of development.
Child-teacher ratio: 6:1 student-to-teacher ratio; well-trained & experienced Early Childhood Educators.
                </div>
