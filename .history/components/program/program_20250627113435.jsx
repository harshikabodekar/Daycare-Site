    ...
    <>
        ...
        <div className="bg-white px-6 py-12 flex flex-col items-center gap-6">
            ...
            <div className="bg-white p-6 rounded-lg border-2">
                <h3 className="text-2xl text-black font-semibold mb-2"><strong>Infants </strong></h3> 
                <ul className="text-black">
                <li> <strong clasname="text-green-600"></strong>Focus Areas: Creating a nurturing and stimulating environment.</li>
                Child-teacher Ratio: 4:1 student to teacher ratio; well-trained & experienced Early Childhood Educators.</ul>
            </div>
            </div>
            </div>
