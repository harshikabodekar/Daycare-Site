...
<li> <strong className="text-green-800">Child-teacher ratio:</strong> 6:1 student-to-teacher ratio; well-trained & experienced Early Childhood Educators.</li> </ul>
            ...
            <p className="text-black">
              <ul>
                <li>  <strong className="text-gree"></li>Focus Areas:</strong> The Preschool program at Clearwater Early Learning Centre will revolve around building and strengthening the foundations learned by the students in the Toddler program.</li>
